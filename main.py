        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                for face_encoding in self.face_encodings:
                    ...
                    # Calculating the shortest distance to face
                    ...
                    self.face_face.append(f'{name} ({confidence})')
                ...
                for (top,right,bottom,left),name in zip(self.face_locations,self.face_names):
                    #Scale back up face locations since the frame we detected in was to 1/4 size
